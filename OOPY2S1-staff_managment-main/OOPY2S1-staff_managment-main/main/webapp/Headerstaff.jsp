	...
	<div class="w3-top">
		<nav class="w3-bar">
			<div class="w3-container">
				<a class="w3-bar-item w3-button" href="#"><h2 class="logo">Hello ${uname}</h2></a>
			...
			<div class="position-sticky">
				...
				<ul class="nav flex-column">
					<li class="nav-item"><a class="nav-link"
						href="userDashboard.jsp"> <i class="fas fa-tachometer-alt"></i>Dashboard
					</a></li>
					<li class="nav-item"><a class="nav-link" href="userDash/leve.jsp"> <i
							class="fas fa-users"></i> leave
					</a></li>
					<li class="nav-item"><a class="nav-link" href="userDash/leavestaffdisplay.jsp">
							<i class="fas fa-calendar-check"></i> leave list
					</a></li>
					<li class="nav-item"><a class="nav-link" href="userDash/Salary.jsp"> <i
							class="fas fa-money-bill"></i> Salary
					</a></li>
				</ul>
			</div>
		</nav>
