		...
		<nav id="sidebar"
			...
			<div class="position-sticky">
				...
				<ul class="nav flex-column">
					...
					<li class="nav-item"><a class="nav-link" href="leve.jsp"> <i
							class="fas fa-users"></i> leave
					</a></li>
					<li class="nav-item"><a class="nav-link" href="leavestaffdisplay.jsp">
							<i class="fas fa-clock"></i> leave list
					</a></li>
					<li class="nav-item"><a class="nav-link" href="Salary.jsp"> <i
							class="fas fa-chart-bar"></i> Salary
					</a></li>
				</ul>
			</div>
		</nav>
